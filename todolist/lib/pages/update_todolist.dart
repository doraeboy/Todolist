...
class _UpdatePageState extends State<UpdatePage> {
    ...
    return Scaffold(
      ...
      actions: [
        IconButton(onPressed: () {
          print("Delete ID: $_v1");
          deleteTodo();
          //ลบแล้ว Back อัตโนมัติ
          Navigator.pop(context); //คือการกด Back
  ...
  Future updateTodo() async {
    //var url = Uri.https('8b23-1-0-202-207.ngrok.io', '/api/post-todolist');
    var url = Uri.http('192.168.2.130:8000', '/api/update-todolist/$_v1');
  ...
  Future deleteTodo() async{
    var url = Uri.http('192.168.2.130:8000', '/api/delete-todolist/$_v1');
    Map<String, String> header = {"Content-type":"application/json"};
